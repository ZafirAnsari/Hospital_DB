...
<body>
	...
	<div class="container h-100 align-items-center">
		<h3 class="d-flex justify-content-center">Doctor Login Page</h3>
		<?php
		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					...
					<form action="doctor-login.php" method="get">
					...
					<input type="password" name="loginPassword" class="form-control input_pass" placeholder="Password">
