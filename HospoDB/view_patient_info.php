...
<body>
	<div class="container h-100 align-items-center">
		<h3 class="d-flex justify-content-center">Enter Patient Email</h3>
		<?php
						if(isset($_GET['emailFail']))
						{
							echo "<p class='d-flex justify-content-center'> Enter correct Email</p>";
						}
		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form action="view_patient_info1.php" method="get">
						<div class="input-group mb-3">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-user"></i></span>
							</div>
							<input type="text" name="loginEmail" class="form-control input_user" value="" placeholder=" Patient Email">
						</div>
